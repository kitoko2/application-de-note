    ...
    if (_editingController.text != "") {
      for (var container in widget.mesNotes) {
        if (container.titre.contains(_editingController.text.toUpperCase()) ||
            container.titre.contains(_editingController.text.toLowerCase())) {
          setState(() {
        ...
        children: [
          ...
          Flexible(
            child: Container(
              ...
              child: Text(
                searchResult() != 0
                    ? 'vous avez ${searchResult()} éléments Commencant par "${_editingController.text}"'
                    : 'No found element',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 20,
